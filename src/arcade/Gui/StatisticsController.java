...
import arcade.Service.DatabaseHelper;
import arcade.animations.Animations;
...
public class StatisticsController implements Initializable {
    ...
    private void setGraphics() {
        datepicker.setOnAction(ev -> {
            ...
            int count = DatabaseHelper.allExistingGamesthisDayByname(date);
            int count3 = DatabaseHelper.allExistingGames(date);
            ...
            if (count == 0  && count3 == 0) {
                ...
                PieChart.Data one = new PieChart.Data("Existing games (in this day): " + count, count);
                data.add(one);
                ...
                PieChart.Data three = new PieChart.Data("allExisting games (count all): " + count3, count3);
                data.add(three);
                pieChart.setData(data);
